...
class RtOverflowTooltipModule {
    ...
    static ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "16.1.2", ngImport: i0, type: RtOverflowTooltipModule, declarations: [RtOverflowTooltipDirective], imports: [RtDefineStrokeWidthModule, MatTooltipModule], exports: [RtOverflowTooltipDirective] });
    static ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "16.1.2", ngImport: i0, type: RtOverflowTooltipModule, imports: [RtDefineStrokeWidthModule, MatTooltipModule] });
}
