...
class RtPlatformService {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "16.1.1", ngImport: i0, type: RtPlatformService, deps: [{ token: PLATFORM_ID }, { token: RtPlatformConfigToken, optional: true }], target: i0.ɵɵFactoryTarget.Injectable });
    static ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "16.1.1", ngImport: i0, type: RtPlatformService, providedIn: 'root' });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "16.1.1", ngImport: i0, type: RtPlatformService, decorators: [{
            type: Injectable,
            args: [{
                    providedIn: 'root',
                }]
...
class RtTransferStateService {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "16.1.1", ngImport: i0, type: RtTransferStateService, deps: [{ token: RtPlatformService }, { token: i2.TransferState }], target: i0.ɵɵFactoryTarget.Injectable });
...
class RtPlatformModule {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "16.1.1", ngImport: i0, type: RtPlatformModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule });
    static ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "16.1.1", ngImport: i0, type: RtPlatformModule, imports: [CommonModule] });
    static ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "16.1.1", ngImport: i0, type: RtPlatformModule, providers: [RtPlatformService, WindowService, { provide: WINDOW, useFactory: factoryFn, deps: [WindowService] }], imports: [CommonModule] });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "16.1.1", ngImport: i0, type: RtPlatformModule, decorators: [{
            type: NgModule,
            args: [{
                    declarations: [],
